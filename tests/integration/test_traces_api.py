...
def _seed_trace_data(client: TestClient, org_id: str) -> tuple[str, str]:
    ...
    return str(primary_trace_id), str(failed_trace_id)
...
def test_trace_end_to_end_smoke(client: TestClient) -> None:
    ...
    primary_trace_id, failed_trace_id = _seed_trace_data(client, org_id)
